...
import type { CannabinoidServing, ProductNutrition } from '@/types/woocommerce';
...
async function fetchProductExtras(
  ...
  Omit<SingleProductExtras, 'nutrition' | 'cannabinoids' | 'reviewData'> & {
...
export const getStaticProps: GetStaticProps = async (ctx) => {
  ...
  try {
    const [menuClient, result, { extras, reviewData }, nutritionData] = await Promise.all([
      prefetchMenus(),
