  ...
  return (
    <Html lang="en" translate="no">
      <Head>
        ...
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,100..1000;1,9..40,100..1000&family=Merriweather:ital,wght@0,300;0,400;0,700;0,900;1,400&display=swap"
        />
        <link
          rel="stylesheet"
