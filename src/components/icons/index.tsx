 ...
 *
 * Centralized icon definitions for consistent styling across the app.
 */
...
export const EmailIcon = () => (
  <svg aria-hidden="true" focusable="false" role="presentation" className="icon icon-email" viewBox="0 0 64 64">
...
// Chevron up icon (for expandable sections)
