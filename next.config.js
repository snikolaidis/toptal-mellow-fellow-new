    ...
    if (process.env.NODE_ENV === 'production') {
      securityHeaders.push({
        ...
        value: [
          ...
          "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.yotpo.com https://skynettechnologies.com https://*.skynettechnologies.com https://*.skynettechnologies.us https://*.getverdict.com https://*.idv.link https://idv.link https://unpkg.com https://*.ladesk.com",
          "font-src 'self' data: https://fonts.gstatic.com https://*.klaviyo.com https://*.yotpo.com https://skynettechnologies.com https://*.skynettechnologies.com https://*.skynettechnologies.us https://*.getverdict.com https://*.idv.link https://*.ladesk.com",
          ...
          "frame-src 'self' https://*.yotpo.com https://*.wpengine.com https://*.wpenginepowered.com https://*.getverdict.com https://*.idv.link https://idv.link https://*.ladesk.com",
